...
- Gunakan percabangan dan perulangan untuk mempermudah, 
  ...
  #catatan penting
    Fungsi Len() untuk menghitung jumlah elemen dalam daftar
    Fungsi Sum() untuk menjumlahkan semua nilai dalam daftar
    Fungsi mean() untuk menghitung rata-rata dari kumpulan data yang diberikan
"""
